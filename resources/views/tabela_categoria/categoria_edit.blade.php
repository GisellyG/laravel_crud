    ...
    <div class="max-w-2xl mx-auto py-12">
        ...
        <form action="{{ route('categorias.update', ['categoria' => $categoria->id]) }}" method="post" class="bg-white dark:bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="funcao" id="funcao" value="{{ $categoria->funcao }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline">
            </div>
